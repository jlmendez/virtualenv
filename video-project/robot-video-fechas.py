...
try:
    ...
    date_time = '2020-06-25 10:00:00' #now.strftime("%Y-%m-%d %H:%M:%S")
    date_time2 = '2020-06-24 14:35:00'#past_time.strftime("%Y-%m-%d %H:%M:%S")
...
out = cv2.VideoWriter('/home/incyt/servicio/uploads/project.webm',cv2.VideoWriter_fourcc(*'vp80'), 10, size)
