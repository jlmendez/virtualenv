...
try:
    ...
    Q = '''select fecha_sistema, 
	    ...
	    where   to_char(fecha_sistema, 'yyyy-mm-dd hh24:mi') >= '2020-09-09 06:50'
...
for r in df.iterrows():
    ...
    if pd.isna(r[1].values[10]) and linea > 1:
        t_header1= 'TIMESERIES GI_ISE2I_01_BDF_D, '+str(linea-1) + ' samples, 55 sps, ' + f_date +'T'+f_time +', SLIST, INTEGER, Counts\r\n'
        t_header2= 'TIMESERIES GI_ISE2I_02_BDF_D, '+str(linea-1) + ' samples, 55 sps, ' + f_date +'T'+f_time +', SLIST, INTEGER, Counts\r\n'
        t_header3= 'TIMESERIES GI_ISE2I_03_BDF_D, '+str(linea-1) + ' samples, 55 sps, ' + f_date +'T'+f_time +', SLIST, INTEGER, Counts\r\n'
        t_header4= 'TIMESERIES GI_ISE2I_04_BDF_D, '+str(linea-1) + ' samples, 55 sps, ' + f_date +'T'+f_time +', SLIST, INTEGER, Counts\r\n'
...
#        print(infra_string)
        ...
        print(t_header2)
        os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed3.txt -o /home/incyt/servicio/uploads/GI_ISE2I_03_BDF_D_'+f_date +'T'+f_time +'.mseed')
        print(t_header3)
...
os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed1.txt -o /home/incyt/servicio/uploads/GI_ISE2I_01_BDF_D_'+f_date +'T'+f_time +'.mseed')
print(t_header1)
Q= "insert into polls_mseed_files(fecha_sistema,filename,estacion,sensor_tipo_sensor_num) values('{0}','{1}','GI_ISE2I','IS',1)".format(f_date, ' /home/incyt/servicio/uploads/GI_ISE2I_01_BDF_D_'+f_date +'T'+f_time +'.mseed')
cursor.execute(Q)

os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed2.txt -o /home/incyt/servicio/uploads/GI_ISE2I_02_BDF_D_'+f_date +'T'+f_time +'.mseed')
print(t_header2)
Q= "insert into polls_mseed_files(fecha_sistema,filename,estacion,sensor_tipo_sensor_num) values('{0}','{1}','GI_ISE2I','IS',2)".format(f_date, ' /home/incyt/servicio/uploads/GI_ISE2I_02_BDF_D_'+f_date +'T'+f_time +'.mseed')
cursor.execute(Q)


os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed3.txt -o /home/incyt/servicio/uploads/GI_ISE2I_03_BDF_D_'+f_date +'T'+f_time +'.mseed')
print(t_header3)
Q= "insert into polls_mseed_files(fecha_sistema,filename,estacion,sensor_tipo_sensor_num) values('{0}','{1}','GI_ISE2I','IS',3)".format(f_date, ' /home/incyt/servicio/uploads/GI_ISE2I_03_BDF_D_'+f_date +'T'+f_time +'.mseed')
cursor.execute(Q)


os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed4.txt -o /home/incyt/servicio/uploads/GI_ISE2I_04_BDF_D_'+f_date +'T'+f_time +'.mseed')
print(t_header4)
Q= "insert into polls_mseed_files(fecha_sistema,filename,estacion,sensor_tipo_sensor_num) values('{0}','{1}','GI_ISE2I','IS',4)".format(f_date, ' /home/incyt/servicio/uploads/GI_ISE2I_04_BDF_D_'+f_date +'T'+f_time +'.mseed')
cursor.execute(Q)
