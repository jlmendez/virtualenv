...
for i in range(1,len(infrasonido_1)-1):
    ...
    if abs(c-a) > 1000000 and abs(c-p) > 1000000 and abs(p-a) <60000:
        ...
        Q= '''
              update polls_ise2_infra set infrasonido_1 = '{0}' where fecha_sistema = '{1}'
    ...
    if abs(c-a) > 1000000 and abs(c-p) > 1000000 and abs(p-a) <60000:
        ...
        Q= '''
              update polls_ise2_infra set infrasonido_2 = '{0}' where fecha_sistema = '{1}'
    ...
    if abs(c-a) > 1000000 and abs(c-p) > 1000000 and abs(p-a) <60000:
        ...
        Q= '''
              update polls_ise2_infra set infrasonido_3 = '{0}' where fecha_sistema = '{1}'
    ...
    if abs(c-a) > 1000000 and abs(c-p) > 1000000 and abs(p-a) <60000:
        ...
        Q= '''
              update polls_ise2_infra set infrasonido_4 = '{0}' where fecha_sistema = '{1}'
