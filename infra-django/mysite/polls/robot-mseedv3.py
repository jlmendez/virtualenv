...
try:
    ...
    Q = '''select fecha_sistema, 
            ...
            where  fecha_recepcion > (select max(fecha_recepcion) 
                                      from polls_ise2_infra) - interval '5 minutes'
...
for r in df.iterrows():
    ...
    infrasonido_1.append(r[1].values[1]/((2**24)/(935*2)))
    infrasonido_2.append(r[1].values[2]/((2**24)/(935*2)))
    infrasonido_3.append(r[1].values[3]/((2**24)/(935*2)))
    infrasonido_4.append(r[1].values[4]/((2**24)/(935*2)))
    ...
    infra_string1 = infra_string1 + v_tab+ str(r[1].values[1]/((2**24)/(935*2)))
    infra_string2 = infra_string2 + v_tab+ str(r[1].values[2]/((2**24)/(935*2)))
    infra_string3 = infra_string3 + v_tab+ str(r[1].values[3]/((2**24)/(935*2)))
    infra_string4 = infra_string4 + v_tab+ str(r[1].values[4]/((2**24)/(935*2)))
...
os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed1.txt -o /home/incyt/servicio/uploads/GI_ISE2I_01_BDF_D.mseed')
print(t_header1)

os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed2.txt -o /home/incyt/servicio/uploads/GI_ISE2I_02_BDF_D.mseed')

os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed3.txt -o /home/incyt/servicio/uploads/GI_ISE2I_03_BDF_D.mseed')

os.system('sudo /virtualenv/ascii2mseed/ascii2mseed /virtualenv/infra-data/mseed4.txt -o /home/incyt/servicio/uploads/GI_ISE2I_04_BDF_D.mseed')
